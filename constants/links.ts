...
export const PROJECTS_LINKS = {
    ...
    trafficLightsSystem: {
        projectLink: "https://github.com/AndiTaTaEe/Traffic-light-system-for-cars-and-pedestrians"
    },
}

export const RESUME_LINK = "/portfolio-website/CV_Cilichidreanu_Andi.pdf";